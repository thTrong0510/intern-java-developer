...
import com.trong.blog.blog.domain.dto.request.auth.ReqLoginDTO;
import com.trong.blog.blog.domain.dto.response.auth.ResCurrentAccountDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDTO) {
        ...
        resLoginDTO.setUser(new UserLogin_(user.getId(), user.getName(), user.getEmail()));
    ...
    public ResponseEntity<ResCurrentAccountDTO> fetchAccount() {
        ...
        if (user != null) {
            userGetAccount.setUser(new UserLogin_(user.getId(), user.getName(), user.getEmail()));
        }
